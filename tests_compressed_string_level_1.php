...
<body style="font-family: monospace">
	...
	<script type="application/javascript">
	  ...
	  var repetitions = 100;
	  //getResponse("column_1", "tests/php_array.php", repetitions);
	  //getResponse("column_2", "tests/json_string.php", repetitions);
	  getResponse("logging-info", "tests/compressed_string_level_1.php", repetitions);
	  //getResponse("column_4", "tests/compressed_string_level_6.php", repetitions);
